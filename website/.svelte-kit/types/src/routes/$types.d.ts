...
type LayoutRouteId = RouteId | "/" | "/admin" | "/admin/jobs" | "/admin/media" | "/admin/requests" | "/admin/roles" | "/admin/users" | "/auth/login" | "/requests" | "/search" | "/watch/[uid]" | null
type LayoutParams = RouteParams & { uid?: string }
